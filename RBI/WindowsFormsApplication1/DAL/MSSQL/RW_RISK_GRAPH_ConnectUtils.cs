    ...
    class RW_RISK_GRAPH_ConnectUtils
    {
        public void add(RW_RISK_GRAPH obj)
        {
            ...
            string sql = "INSERT INTO rbi.dbo.RW_RISK_GRAPH" +
                         ...
                         "VALUES ('" + obj.ID + "','" + obj.Risk[0] + "','" + obj.Risk[1] + "','" + obj.Risk[2] + "','"+obj.Risk[3]+"','"+obj.Risk[4]+"','"+obj.Risk[5]+"','"+obj.Risk[6]+"','"+obj.Risk[7]+"','"+obj.Risk[8]+"','"+obj.Risk[9]+"','"+obj.Risk[10]+"','"+obj.Risk[11]+"','"+obj.Risk[12]+"','"+obj.Risk[13]+"','"+obj.Risk[14]+"')";
            try
            {
        ...
        public List<float> GetData(int ID)
        {
            List<float> lstRisk = new List<float>();
            SqlConnection con = MSSQLDBUtils.GetDBConnection();
            con.Open();
            ...
            try
            {
                ...
                using (DbDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        for (int i = 1; i < 16; i++)
                        {
                            lstRisk.Add((float)reader.GetDouble(i));
                        }
                    }
                }
            }
